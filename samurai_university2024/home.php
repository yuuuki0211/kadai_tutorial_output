    ...
    <div class="news">
      <div class="footer_row">
        <div class="row news_row">
          ...
          <!-- 卒業生の声 -->
          <div class="col-lg-6 col-md-6 col-sx-12 news_col" style="marjintop 50px">
    ...
    <!-- 数字 -->
    <div class="counter">
    <div class="counter_background" style="background-image: url(<?php echo get_template_directory_uri();?>/images/pic_chart.png)"></div>      <div class="footer_row">
        <div class="">
          <div class="">
